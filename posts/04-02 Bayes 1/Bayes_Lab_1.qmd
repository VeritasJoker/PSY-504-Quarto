...
$\text{bill_length_mm}_i = \beta_0 + \beta_1 \text{body_mass_g}_i + \epsilon_i$ $\epsilon_i \sim \operatorname{Normal}(0, \sigma_\epsilon)$
...
$\text{bill_length_mm}_i \sim \operatorname{Normal}(\mu_i, \sigma)$ $\mu_i = \beta_0 + \beta_1 \text{body_mass_g}_i$
