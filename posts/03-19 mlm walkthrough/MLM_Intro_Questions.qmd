...
```{r}
print("The line is the same for every type of toy since we are fitting a general model for all toys. However, the line obviously does not fit some types of toys (both the intercept and slope.")
```
...
print("For the first two models, the green and blue lines have different intercepts for different toy types, but still have the same slope for all lines. For the thir model, the orange lines have different intercepts and slopes, which fits some toy types, like Minecraft and Sock Puppets, better.")
...
print("The solutions are more detailed and also explains the reasons, which are pretty nice.")
